      ...
      <div className="container mx-auto px-4 py-8 animate-in fade-in duration-1500">
        <div className="max-w-2xl mx-auto space-y-8">
          <div className="text-center space-y-4 animate-in slide-in-from-top duration-1200">
            <h1 className="text-3xl md:text-4xl font-bold bg-gradient-to-r from-fitness-weight to-primary bg-clip-text text-transparent">
              Track Your Weight
            </h1>
            <p className="text-lg text-muted-foreground">
              Monitor your weight progress and track changes over time to stay on top of your fitness goals.
            </p>
          </div>
          <div className="animate-in slide-in-from-bottom duration-1200 delay-600">
            <WeightForm onWeightAdded={handleDataUpdate} />
          </div>
        </div>
      </div>
    </div>
